...
class UpdateVideoUploadProvider extends ChangeNotifier {
  ...
  Future<bool> startUpload(body,video) async {
    ...
    if (body != null ) {
      String addVideoUrl = 'https://video.bangapp.pro/api/v1/upload-update-video';
    ...
    try {
      if (_videoId != null ) {
        final response = await http.get(
          Uri.parse('https://video.bangapp.pro/api/v1/get/video/update-processing-status?contentId=$_videoId'),
        );
        if (response.statusCode == 200) {
